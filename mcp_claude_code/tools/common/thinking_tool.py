...
This module provides the thinking tool for Claude to engage in structured thinking.
...
async def think(
    thought: Annotated[
        str,
        Field(
            description="The thought content to record for structured thinking and analysis",
            min_length=1,
        ),
    ],
    ctx: MCPContext,
    ...
    * Performance tests with large codebases
    ...
    Args:
        thought: The thought content to record
        ctx: MCP context for the tool call

    Returns:
        Confirmation message that the thinking process was recorded
    """
...
def register_thinking_tool(mcp_server: FastMCP) -> None:
    """Register the thinking tool with the MCP server.

    Args:
        mcp_server: The FastMCP server instance
    """
    mcp_server.tool()(think)
