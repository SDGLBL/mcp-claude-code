...
def format_notebook_cells(cells: list[NotebookCellSource]) -> str:
...
class JupyterBaseTool(FileSystemTool, ABC):
    ...
    async def parse_notebook(
        ...
        """Parse a Jupyter notebook file (delegates to standalone function).
        ...
        Returns:
            Tuple of (notebook_data, processed_cells)
        """
        return await parse_notebook(file_path)

    def format_notebook_cells(self, cells: list[NotebookCellSource]) -> str:
        """Format notebook cells as a readable string (delegates to standalone function).
        ...
        Returns:
            Formatted string representation of the cells
        """
        return format_notebook_cells(cells)
